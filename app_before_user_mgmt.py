...
# Configurações IMPORTANTES - DEVEM VIR LOGO APÓS CRIAR O APP
app.config['SECRET_KEY'] = 'dev-secret-key-change-in-production-123456789'
app.config['WTF_CSRF_ENABLED'] = True
app.config['WTF_CSRF_TIME_LIMIT'] = None
# Criar diretório instance se não existir

# Configuração do caminho do banco de dados para Windows
import os
from pathlib import Path
